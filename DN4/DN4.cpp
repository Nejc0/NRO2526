...
int main() {
    ...
    for (int ii = 0; ii < 2000; ii++)
    {
        /*
          ===================================================================================
          GAUSS-SEIDEL (GS) METODA.

          Gauss-Seidel metoda je iterativna metoda za reševanje sistema enačb A * T = b.
          V vsaki iteraciji računamo nove vrednosti vektorja T po vrsticah, eno za drugo.

          Ko izračunamo novo vrednost T[jj], jo takoj shranimo nazaj v vektor T.
          To pomeni, da se pri naslednjem koraku že uporabljajo nove vrednosti,
          stare vrednosti pa še niso vse posodobljene.

          Zaradi tega so posamezni koraki med seboj odvisni.
          Če bi uporabili OpenMP in paralelizirali zanko po indeksu jj,
          bi se izračuni izvajali v napačnem vrstnem redu in metoda ne bi pravilno delovala.
          Zato Gauss-Seidel metode ni mogoče enostavno paralelizirati.
          ===================================================================================
        */
